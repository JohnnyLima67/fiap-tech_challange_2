...
var find_by_keywords_exports = {};
__export(find_by_keywords_exports, {
  findByKeywords: () => findByKeywords
});
module.exports = __toCommonJS(find_by_keywords_exports);
...
async function findByKeywords(request, reply) {
  const querySchema = import_zod2.z.object({
    keywords: import_zod2.z.string().min(1).max(100),
